...
# from utils.model_trainer import run_all_predictions, train_and_predict
...
# if app._got_first_request == False:
#     print("🔄 Training models & generating predictions...")
#     run_all_predictions()
#     print("✅ Predictions ready.")
...
#         else:
#             res = train_and_predict(symbol)   # retrain on-demand
#             if res:
#                 prediction = res
#             else:
...
#     # Download dataset once when app starts
#     download_dataset()
...
app = Flask(__name__, template_folder=os.path.join(BASE_PATH, "../frontend/templates"))
